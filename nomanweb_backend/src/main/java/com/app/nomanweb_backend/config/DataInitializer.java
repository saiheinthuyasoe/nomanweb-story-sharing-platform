...
public class DataInitializer implements CommandLineRunner {
        ...
        private void initializeSampleData() {
                if (storyRepository.count() == 0) {
                        ...
                        log.info("Successfully initialized {} users and {} stories", sampleUsers.size(),
                                        sampleStories.size());
                } else {
        ...
        private List<User> createSampleUsers() {
                return Arrays.asList(
                                User.builder()
                                                ...
                                                .lineUserId("U1234567890abcdef1234567890abcdef") // Test LINE User ID
        ...
        private List<Story> createSampleStories(List<User> users) {
                ...
                return Arrays.asList(
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "In a world where magic flows through ancient crystals, young Aria discovers she's the key to preventing an eternal darkness. Join her epic journey across mystical realms as she learns to harness her newfound powers and unite the scattered kingdoms against an ancient evil.")
                                                .author(users.get(0))
                                                ...
                                                .totalChapters(24)
                                                .isFeatured(true)
                                                .tags(Arrays.asList("fantasy", "magic", "adventure", "prophecy",
                                                                "crystals"))
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "When the last dragon rider falls, the kingdom faces its darkest hour. Follow Kael as he discovers his heritage and bonds with the legendary dragon Shadowfire to restore balance to the realm.")
                                                .author(users.get(0))
                                                .category(getCategoryBySlug(categories, "fantasy"))
                                                .coverImageUrl("https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400")
                                                .publishStatus(Story.PublishStatus.PUBLISHED)
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "In 2157, Dr. Elena Vasquez discovers that her quantum experiments are creating rifts in reality itself. As parallel universes begin to collide, she must race against time to prevent the collapse of all existence.")
                                                .author(users.get(1))
                                                ...
                                                .totalChapters(18)
                                                .isFeatured(true)
                                                .tags(Arrays.asList("sci-fi", "quantum", "parallel-universe",
                                                                "science"))
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "The first human settlement on Mars faces extinction when their life support systems begin failing. Commander Sarah Mitchell must lead her team through impossible odds to ensure humanity's survival on the red planet.")
                                                .author(users.get(1))
                                                .category(getCategoryBySlug(categories, "science-fiction"))
                                                .coverImageUrl("https://images.unsplash.com/photo-1446776877081-d282a0f896e2?w=400")
                                                .publishStatus(Story.PublishStatus.PUBLISHED)
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "When successful businesswoman Lily inherits her grandmother's old coffee shop, she never expected to find love with the charming baker next door. A heartwarming tale of second chances and finding home in unexpected places.")
                                                .author(users.get(2))
                                                ...
                                                .totalChapters(28)
                                                .isFeatured(true)
                                                .tags(Arrays.asList("romance", "coffee-shop", "small-town", "completed",
                                                                "heartwarming"))
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "A time-traveling love story where Emma discovers letters from her future self, leading her to the love of her life across different timelines. But changing the past comes with unexpected consequences.")
                                                .author(users.get(2))
                                                .category(getCategoryBySlug(categories, "romance"))
                                                .coverImageUrl("https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400")
                                                .publishStatus(Story.PublishStatus.PUBLISHED)
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "Detective Marcus Kane only works the night shift, but when a series of murders occurs during the day, he must confront his mysterious past and the reason he can't face the sunlight.")
                                                .author(users.get(3))
                                                ...
                                                .totalChapters(22)
                                                .isFeatured(true)
                                                .tags(Arrays.asList("mystery", "detective", "crime", "supernatural",
                                                                "night"))
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "When renowned painter Isabella Moreau disappears from her locked studio, leaving behind only a half-finished painting that seems to move on its own, art curator David Chen must unravel the mystery before more artists vanish.")
                                                .author(users.get(3))
                                                .category(getCategoryBySlug(categories, "mystery"))
                                                .coverImageUrl("https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=400")
                                                .publishStatus(Story.PublishStatus.PUBLISHED)
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "The Blackwood Manor has stood empty for decades, but when the Morrison family moves in, they discover that some houses never forget their past. The walls whisper secrets that should have stayed buried.")
                                                .author(users.get(4))
                                                ...
                                                .totalChapters(19)
                                                .isFeatured(true)
                                                .tags(Arrays.asList("horror", "haunted-house", "supernatural", "family",
                                                                "secrets"))
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "In a world where dreams can be digitally recorded and shared, sleep therapist Dr. Anna Cross discovers that someone is planting nightmares in her patients' minds. But the real horror is discovering who's behind it.")
                                                .author(users.get(4))
                                                .category(getCategoryBySlug(categories, "horror"))
                                                .coverImageUrl("https://images.unsplash.com/photo-1520637836862-4d197d17c93a?w=400")
                                                .publishStatus(Story.PublishStatus.PUBLISHED)
                                                ...
                                                .totalComments(234L)
                                                .totalChapters(14)
                                                .tags(Arrays.asList("horror", "technology", "dreams", "psychological",
                                                                "thriller"))
                                ...
                                Story.builder()
                                                ...
                                                .description(
                                                                "When archaeologist Dr. Rebecca Stone discovers a map to the legendary City of Gold, she assembles a team for the most dangerous expedition of her career. But the jungle holds secrets darker than any treasure.")
                                                .author(users.get(0))
                                                ...
                                                .totalChapters(21)
                                                .isFeatured(true)
                                                .tags(Arrays.asList("adventure", "archaeology", "jungle", "treasure",
                                                                "expedition"))
