    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">
          OAuth Image Migration
        </h1>
        <p className="text-gray-600">
          Migrate external OAuth profile images to Cloudinary to prevent rate
          limiting issues
        </p>
      </div>
        ...
        {stats && !stats.needsMigration && (
          <div className="mt-4 p-4 bg-green-100 border border-green-300 rounded-lg flex items-center">
            ...
            <span className="text-green-800">
              All profile images are already migrated!
            </span>
          </div>
        )}
      </Card>
            ...
            <div className="flex items-start">
              ...
              <div className="text-yellow-800">
                ...
                <ul className="text-sm space-y-1 list-disc list-inside ml-4">
                  <li>
                    This will download external OAuth images and store them in
                    Cloudinary
                  </li>
                  <li>
                    The process may take several minutes depending on the number
                    of images
                  </li>
                  <li>
                    Users will continue to see their images during migration
                  </li>
                  <li>
                    Failed migrations will keep the original external URL as
                    fallback
                  </li>
                </ul>
              </div>
