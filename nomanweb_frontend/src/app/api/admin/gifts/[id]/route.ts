  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        ...
        return NextResponse.json({ error: 'Failed to update gift' }, { status: response.status });
      }
    }
  ...
  try {
    ...
    if (!response.ok) {
      ...
      try {
        ...
        return NextResponse.json({ error: 'Failed to delete gift' }, { status: response.status });
      }
    }
