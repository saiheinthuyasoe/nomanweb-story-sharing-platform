  ...
  useEffect(() => {
    ...
    const handleLineCallback = async () => {
      try {
        ...
        if (!storedState) {
          console.warn(
            "No stored state found, but continuing with callback..."
          );
        ...
        const tokenResponse = await fetch(
          "https://api.line.me/oauth2/v2.1/token",
          {
            ...
            body: new URLSearchParams({
              ...
              client_id:
                process.env.NEXT_PUBLIC_LINE_CHANNEL_ID || "2007499018",
              client_secret:
                process.env.NEXT_PUBLIC_LINE_CHANNEL_SECRET ||
                "fde2263703ef7429ba83b5d1daa5b9de",
            }),
          }
        );
        ...
        if (mode === "link") {
          ...
          try {
            ...
            toast.error(
              error.response?.data?.error || "Failed to link LINE account"
            );
