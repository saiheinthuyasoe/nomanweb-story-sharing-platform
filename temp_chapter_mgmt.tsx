...
export default function ChapterManagement({
  ...
  const handleDelete = async (chapterId: string) => {
    console.log(`≡ƒöì Attempting to move chapter to trash: ${chapterId}`);
    console.log(`≡ƒôè Story pricing type: ${story?.pricingType}`);
    ...
    <div key={refreshKey} className="card-elevated p-6">
      ...
      {showBulkUpload && (
        <BulkChapterUpload
          storyId={storyId}
          onSuccess={async () => {
            console.log("≡ƒô▒ ChapterManagement onSuccess called");
            ...
            console.log("≡ƒöä Refetching chapters in ChapterManagement...");
            await refetch();
            console.log("Γ£à ChapterManagement refetch complete");
          }}
          onClose={() => {
            setShowBulkUpload(false);
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <ul className="text-sm text-blue-700 space-y-1">
                    <li>ΓÇó The chapter will be moved to drafts</li>
                    <li>ΓÇó Readers will lose access to this chapter</li>
                    {story?.pricingType === "WHOLE_BOOK" && (
                      <li>
                        ΓÇó Affected users may receive refunds automatically
                      </li>
                    )}
                    <li>ΓÇó You can republish later if needed</li>
                  </ul>
                </div>
              </div>
            </div>
