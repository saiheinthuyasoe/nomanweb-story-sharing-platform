...
CREATE TABLE stories (
    ...
    pricing_type ENUM('free', 'paid_per_chapter', 'whole_book') DEFAULT 'free',
    content_status ENUM('ongoing', 'completed') DEFAULT 'ongoing',
    book_price DECIMAL(8,2) NULL,
    default_chapter_price DECIMAL(8,2) NULL,
...
CREATE TABLE reading_lists (
    ...
    user_id UUID NOT NULL,
    story_id UUID NOT NULL,
    list_type ENUM('reading', 'completed', 'like', 'want_to_read', 'purchased', 'history') NOT NULL,
